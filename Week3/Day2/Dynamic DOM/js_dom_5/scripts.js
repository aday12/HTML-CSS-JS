...
// Use confirm to ask if the user wants to create a new paragraph
...
while (wantsToCreateParagraph) {
  ...
  /* 
        YOUR CODE GOES HERE 
    */
    let userTxt = prompt("What do you want it to say?");
  ...
  /* 
        YOUR CODE GOES HERE 
    */
      document.getElementById("paragraph_container").appendChild(newPara);
